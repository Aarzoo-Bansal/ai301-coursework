...
I prefer bounded software engineering issues involving Python, backend logic, debugging, and automated testing. I prefer issues with a clear reproduction path and concrete expected behavior. Small documentation changes are acceptable, but implementation and testing work is a better fit when the scope is similarly well defined.